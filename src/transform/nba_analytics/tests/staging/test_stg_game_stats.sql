...
{% call dbt_unit_testing.test ('stg_game_stats', 'test_stg_game_stats') %}
    ...
    season_id,game_id,game_date::date,game_location,win_loss,team,team_name,opponent,opponent_name,team_pts,team_fgm,team_fga,team_fg_pct,team_fg3m,team_fg3a,team_fg3_pct,team_ftm,team_fta,team_ft_pct,team_oreb,team_dreb,team_reb,team_ast,opponent_pts,opponent_fgm,opponent_fga,opponent_fg_pct,opponent_fg3m,opponent_fg3a,opponent_fg3_pct,opponent_ftm,opponent_fta,opponent_ft_pct,opponent_oreb,opponent_dreb,opponent_reb,opponent_ast
